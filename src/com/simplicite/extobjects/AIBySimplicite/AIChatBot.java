...
public class AIChatBot extends com.simplicite.util.ExternalObject {
    ...
    public Object display(Parameters params) {
        ...
        try {
            ...
            return javascript(getName() + ".render(ctn,"+isAdaContext()+",\"\",\""+AITools.getDataDisclaimer(g)+"\",'"+id+"');");
        }
        catch (Exception e) {
    ...
    private String initHist(){
        Grant g = getGrant();
        JSONObject json = g.getJSONObjectParameter("AI_CHAT_HIST","{}");
        String id  =  UUID.randomUUID().toString();
        while(json.has(id))id  =  UUID.randomUUID().toString();
        json.put(id, new JSONArray());
